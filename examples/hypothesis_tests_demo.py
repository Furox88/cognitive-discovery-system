...
print(f"H0: mean == 4.5  ->  t = {res.statistic:.3f}, "
...
print(f"Pooled: t = {pooled.statistic:.3f}, df = {pooled.df:.1f}, "
      f"p = {pooled.p_value:.5f}")
print(f"Welch : t = {welch.statistic:.3f}, df = {welch.df:.2f}, "
      f"p = {welch.p_value:.5f}")
...
print(f"F = {anova.statistic:.3f}, df_between = {anova.df}, "
      f"p = {anova.p_value:.6f}")
