...
class TestTrapezoid:
    ...
    def test_quadratic_error_order(self):
...
class TestSimpson:
    ...
    def test_invalid_odd_n(self):
        with pytest.raises(ValueError):
            simpson(lambda x: x, 0, 1, 3)

    def test_invalid_n_below_two(self):
        with pytest.raises(ValueError):
...
class TestSimpson38:
    ...
    def test_invalid_n_below_3(self):
        with pytest.raises(ValueError):
...
class TestRomberg:
    ...
    def test_converges_to_high_precision(self):
        # ∫_0^1 e^x dx = e - 1
...
class TestGaussianQuadrature:
    ...
    def test_internal_nodes_rejects_n0(self):
...
class TestAdaptiveSimpson:
    ...
    def test_concentrates_work_on_hard_region(self):
    ...
    def test_divergent_integrand_raises(self):
...
class TestCrossMethodAgreement:
    def test_all_methods_agree_on_exp(self):
