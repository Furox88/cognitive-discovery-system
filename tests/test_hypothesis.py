...
def test_hypothesis_to_markdown():
    h = Hypothesis(
        id="test-1",
...
def test_hypothesis_model_fields():
    h = Hypothesis(
        id="h-1",
        statement="stmt",
